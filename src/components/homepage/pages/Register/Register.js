        ...
        <div className="split__wrapper">
            ...
            <div className="split__right">
                <form className="form__main">
                    <input type="email" className="form__input form__active" placeholder="Email" />
                    ...
                    <input type="email" className="form__input" placeholder="Repetera lösenord" />
                    <div className="form__btn-wrapper">
                        <button type="submit" className="form__button">Registrera dig</button>
